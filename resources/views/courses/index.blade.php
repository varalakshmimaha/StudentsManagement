                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="bg-indigo-50/50 border-b border-indigo-100">
                                <th class="px-6 py-3 border-b border-gray-200 text-left text-xs leading-4 font-black text-black uppercase tracking-wider">Course Name</th>
                                <th class="px-6 py-3 border-b border-gray-200 text-left text-xs leading-4 font-black text-black uppercase tracking-wider">Duration</th>
                                <th class="px-6 py-3 border-b border-gray-200 text-left text-xs leading-4 font-black text-black uppercase tracking-wider">Default Total Fee</th>
                                ...
                                <th class="px-6 py-3 border-b border-gray-200 text-left text-xs leading-4 font-black text-black uppercase tracking-wider">Created Date</th>
