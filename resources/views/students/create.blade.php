        ...
        <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select onchange="filterBatches(); fetchCourseFee()" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('course_id') border-red-500 @enderror" id="course_id" name="course_id">
                        ...
                        @foreach($courses as $course)
                            <option value="{{ $course->id }}" data-fee="{{ $course->total_fee ?? 0 }}" {{ old('course_id') == $course->id ? 'selected' : '' }}>{{ $course->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('total_fee') border-red-500 @enderror" id="total_fee" type="number" step="0.01" name="total_fee" value="{{ old('total_fee', 0) }}" oninput="calculateFinalFee()">
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight focus:outline-none focus:shadow-outline" id="final_fee" type="number" step="0.01" name="final_fee" value="{{ old('final_fee', 0) }}" readonly>
            ...
            <div class="mb-6">
                ...
                <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="notes" name="notes" rows="2">{{ old('notes') }}</textarea>
            </div>
...
<script>
    ...
    // Run on load to correct batch visibility if old input exists
